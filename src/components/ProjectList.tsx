...
const ProjectList = () => {
  ...
  return (
    <section className="pb-section overflow-auto" id="selected-projects">
      <div className="container">
        ...
        <div className="group/projects relative" ref={containerRef}>
          {selectedProject !== null && (
            <div
              className="max-md:hidden absolute right-0 top-0 z-1 pointer-events-none w-50 xl:w-87.5 aspect-3/4 overflow-hidden opacity-0"
              ref={imageContainer}
            >
              {PROJECTS.map((project) => (
                <Image
                  ...
                  className={`absolute inset-0 transition-all duration-500 w-full h-full object-cover ${
                    project.slug !== selectedProject ? "opacity-0" : ""
                  }`}
                  ref={imageRef}
                  key={project.slug}
                />
